...
CCG Gateway is a desktop management tool for Agents including Claude Code, Codex, Gemini CLI, OpenCode, Kimi Code, ZCode, and Grok Build, integrating an intelligent gateway, account management, and configuration management.
...
- Built-in support for Claude Code, Codex, Gemini CLI, OpenCode, Kimi Code, ZCode, and Grok Build.
