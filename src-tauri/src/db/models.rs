...
pub struct CliSettingsUpdate {
    ...
    pub default_json_config: Option<String>,
    pub config_dir: Option<String>,
    pub config_write_mode: Option<String>,
}
...
pub struct SystemStatus {
    ...
    pub error_message: Option<String>,
    pub host_env_override: bool,
    pub port_env_override: bool,
    pub data_dir: String,
    pub default_data_dir: String,
    pub data_dir_env_override: bool,
    pub log_file: bool,
    pub log_file_env_override: bool,
    pub log_level: String,
    pub log_level_env_override: bool,
    pub uptime: i64,
    pub version: String,
}
